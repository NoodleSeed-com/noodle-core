...
const authorized = [
  ...
  ['GET', `${base}/history/settings`],
  ['PUT', `${base}/history/settings`],
  ['GET', `${base}/conversations`],
  ['GET', `${base}/conversations/export`],
  ['POST', `${base}/conversations/forget`],
  ['GET', `${base}/conversations/cv_conversation_1`],
  ['PATCH', `${base}/conversations/cv_conversation_1`],
  ['POST', `${base}/grants`],
...
const denied = [
  ...
  ['GET', `${base}/activate`],
  ['PATCH', `${base}/activate`],
  ['GET', `${base}/activity/settings`],
  ['PATCH', `${base}/activity/settings`],
  ['PATCH', `${base}/history/settings`],
  ...
  ['PATCH', `${base}/conversations/export`],
  ['GET', `${base}/conversations/forget`],
  ['DELETE', `${base}/conversations/cv_conversation_1`],
  ['PATCH', `${base}/conversations/cv_conversation_1/notes`],
