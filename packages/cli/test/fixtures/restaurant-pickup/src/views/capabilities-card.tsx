...
export default function CapabilitiesCard() {
  ...
  return (
    <main
      ...
      data-llm={`Restaurant Pickup capabilities: ${capabilities.map((item) => item.name).join(', ')}`}
    >
        ...
        <header className="nw-header">
          ...
          <div className="nw-title-block">
            ...
            <p className="nw-subtitle">
              {structured?.status ?? 'Restaurant Pickup widget capabilities are ready.'}
            </p>
          </div>
        ...
        <div className="nw-body">
          ...
          <div className="nw-actions">
            <button
              ...
              onClick={() =>
                sendFollowUpMessage({
                  prompt: 'Summarize what the Restaurant Pickup MCP App widget demonstrates.',
                })
              }
            >
              <SparkIcon />
