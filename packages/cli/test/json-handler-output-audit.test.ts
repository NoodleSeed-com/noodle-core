...
const HANDLER_FAMILY_SURFACES = {
  ...
  channels: [
    ...
    'channels whatsapp doctor',
    'channels whatsapp enable',
    'channels whatsapp pause',
    'channels whatsapp disconnect',
    'channels whatsapp webhook inspect',
    'channels whatsapp webhook configure',
    'channels whatsapp limits get',
    'channels whatsapp limits set',
    'channels whatsapp usage',
    'channels whatsapp blocks list',
    'channels whatsapp block',
    'channels whatsapp unblock',
    'channels whatsapp cooldown inspect',
    'channels whatsapp cooldown clear',
  ...
  solutions: [
    ...
    'solutions history settings get',
    'solutions history settings set',
    'solutions conversations list',
    'solutions conversations show',
    'solutions conversations review',
    'solutions conversations note',
