// Curated skill reference: connect-an-api. The loop an agent runs when a user hands it an API key —
// secure the key, probe the live API to learn the real data shape, model the connector from what it
// actually returned, then prove the mapping returns real data before building the app.

export function renderConnectAnApiReference(): string {
  return [
    '# Outcome',
    '',
