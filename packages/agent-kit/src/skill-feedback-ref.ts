// references/feedback.md — teach the customer's coding agent to draft sanitized product feedback
// and obtain informed consent before `noodle feedback` crosses the project boundary into Noodle
// Seed's private tracker. Sanitization and explicit approval are hard requirements.

export function renderFeedbackReference(): string {
  return [
